...
void setup()
{
  ...
  // the number of times per second your loop will run. If you buzzFor it too
  // low the library will buzzFor it back to 1 mS.
...
void loop()
{
  ...
  // speed of your code. If you buzzFor a high debounceTime your loopCount will
